...
public class ThingsWithThingsWithInstantQueryProvider extends SelectSparqlQueryProvider {
    ...
    public ThingsWithThingsWithInstantQueryProvider(){
        this.start = null;
        this.end = null;
    }

    public ThingsWithThingsWithInstantQueryProvider(Date start, Date end){
        this.start = start;
        this.end = end;
    }
