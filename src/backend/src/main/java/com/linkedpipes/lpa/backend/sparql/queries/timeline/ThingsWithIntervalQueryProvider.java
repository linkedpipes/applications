...
public class ThingsWithIntervalQueryProvider extends SelectSparqlQueryProvider {
    private Date start;
    private Date end;
    ...
    public ThingsWithIntervalQueryProvider(){
        this.start = null;
        this.end = null;
    }

    public ThingsWithIntervalQueryProvider(Date start, Date end){
        this.start = start;
        this.end = end;
    }
