...
create table execution (id int8 not null, execution_iri TEXT not null, etl_pipeline_iri varchar(255) not null, selected_visualiser varchar(255) not null, status varchar(255), user_id int8, primary key (id));
